...
/*            input[type='submit'] {
  ...
  <!-- top -->
    <?php if (login_check($mysqli) == true) : ?>
        ...
        <?php
            $req     = 'select Profil as profily, RefEmploye as ref from employes '
                . 'where Nomuser = "'.$Nomuser.'"';
                                                ...
                                                <ul style=" list-style-type: none">
                                                    ...
                                                    <table>  
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <textarea type="text" name="client" id="client" readonly="true" style="width:173px" ><?php echo $cli; ?></textarea>                                                                                                                    
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <textarea type="text" name="typeClient" id="typeClient" readonly="true" style="width:173px" ><?php echo $cliType; ?></textarea>                                                    
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><label id="labstat" for="stat" style="display: none"> STAT</label></td>
                                                            <td><textarea type="text" name="stat" id="stat" readonly="true" style="display: none;width:173px" placeholder="11111 11 1111 11111"><?php echo $stat;?></textarea></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label id="labnif" for="nif" style="display: none"> N.I.F </label></td>
                                                            <td><textarea type="text" name="nif" id="nif" readonly="true" style="display: none;width:173px" placeholder="1111111111"><?php echo $nif;?></textarea></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label id="labcif" for="cif" style="display: none"> C.I.F </label></td>
                                                            <td><textarea type="text" name="cif" id="cif" readonly="true" style="display: none;width:173px" placeholder="1111111/DGI-B du jj/mm/aaaa"><?php echo $cif;?></textarea></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label id="labrcs" for="rcs" style="display: none"> R.C.S </label></td>
                                                            <td><textarea type="text" name="rcs" id="rcs" readonly="true" style="display: none;width:173px" placeholder="1111 B 11111"><?php echo $rcs;?></textarea></td>
                                                        </tr>
                                                    </table>  
                                                <!--</fieldset>-->
                                                </ul>
                                                            ...
                                                            <td>
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" name="signContrat"  style="width:174px" id="signContrat" value="<?php if( $resultInfoC -> Datesignature == "" || $resultInfoC -> Datesignature == "0000-00-00"){echo '';}  else {echo (changeDate2($resultInfoC -> Datesignature));}?>"/></td>                                                                                
                                                                    </tr>
                                                                    <tr>
                                                                        <td><label>Date d'archivage</label></label></td>                                                                        
                                                                        <td><input type="text" name="dteArchiv"  style="width:174px" id="dteArchiv" value="<?php if($resultInfoC -> Datearchctr == "" || $resultInfoC -> Datearchctr == "0000-00-00"){ echo '';} else {echo (changeDate2($resultInfoC -> Datearchctr));}?>"/></td>                        
                                                                    </tr>
                                                                    <tr>
                                                                        <td><label>Date de d&eacute;but pr&eacute;vu</label></td>                                                                        
                                                                        <td><input type="text" name="dtePrevu"  style="width:174px" id="dtePrevu" value="<?php if($resultInfoC -> DateDebutProjet == "" || $resultInfoC -> DateDebutProjet == "0000-00-00"){echo '';} else{ echo (changeDate2($resultInfoC -> DateDebutProjet));}?>" onblur="verifChampNul(this)"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><label>Date de fin pr&eacute;vue</label></td>                                                                        
                                                                        <td><input type="text" name="dteFin"  id="dteFin" style="width:173px" value="<?php if($resultInfoC -> DateFinProjet == "" || $resultInfoC -> DateFinProjet == "0000-00-00"){echo '';} else{ echo (changeDate2($resultInfoC -> DateFinProjet));}?>" onblur="verifChampNul(this)"/> </td>
                                                                    </tr>                                                        
                                                                </table>
                                                            </td>
                                                            <td>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" name="dbuReel"  id="dbuReel" value="<?php if($resultInfoC -> DateDebutR == "" || $resultInfoC -> DateDebutR == "0000-00-00"){echo '';} else{  echo (changeDate2($resultInfoC -> DateDebutR));}?>" style="width:174px"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><label>Date fin r&eacute;elle</label></td>                                                                        
                                                                        <td><input type="text" name="finReel"  id="finReel" value="<?php if($resultInfoC -> DateFinR == "" || $resultInfoC -> DateFinR == "0000-00-00"){echo '';} else{ echo (changeDate2($resultInfoC -> DateFinR));}?>" style="width:174px"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" name="dteAvenant" id="dteAvenant"  value="<?php if($resultInfoC -> Datesignaven == "" || $resultInfoC -> Datesignaven == "0000-00-00"){echo '';} else{ echo (changeDate2($resultInfoC -> Datesignaven));} ?>"  style="display: none; width: 174px" /></td>
                                                                    </tr>
                                                                </table>
                                                                </ul>
                                                            </td>
                                        ...
                                        <div class="cout">
                                            <table id="echeance">                                            
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 175px"></td>
                                                    <td style="width: 172px"><b><input style=" text-align: right; width: 168px" readonly="true" id="montanttotal" name="montanttotal" type="text" value="<?php echo number_format((float)$total, 2, ".", " ");?>" /></b></td>
                                                </tr>                                               
                                                <tr>
                                                    ...
                                                    <td style="width: 172px"><b><input style=" text-align: right; width: 168px" value="<?php echo number_format((float)$tr, 2, ".", " "); ?>" readonly="true" name="montantremise" id="montantremise" type="double" value="" /></b></td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 175px">Montant honoraire (HT)</td>
                                                    <td style="width: 50px"></td>
                                                    <td style="width: 175px"></td>
                                                    <td style="width: 172px"><b><input style=" text-align: right; width: 168px" value="<?php echo number_format((float)$mar, 2, ".", " "); ?>" readonly="true" id="totalavecremise" name="totalavecremise" type="double" value="" /></b></td>
                                                </tr>
                                            </table>
                                        </div>
...
/*****************************************UPDATE PROJET: Infos client et infos contrat et infos facturation**************************/ 
                            ...
                            $reqUpProjet = 'update projets set '
                                ...
                                . 'Adressefacture = "'.$adresseFact.'", Monnaie = "'.$devizy.'", EstimationCoutTotalProjet = "'.$montantHono.'", '
                            ...
                            $reqProjetM = mysqli_query($connect,$reqUpProjet)  or exit(mysqli_error());
