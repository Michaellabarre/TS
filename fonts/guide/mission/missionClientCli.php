                                                            ...
                                                            <td>
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="text" name="dteFin"  id="dteFin" style="width:174px" value="<?php if($resultInfoC -> DateFinProjet == "" || $resultInfoC -> DateFinProjet == "0000-00-00"){echo '';} else{ echo (changeDate2($resultInfoC -> DateFinProjet));}?>" onblur="verifChampNul(this)"/> </td>                                                                                                                                                  
                                                                    </tr>                                                        
                                                                </table>
                                                            </td>
                                                            <td>
