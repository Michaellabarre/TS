...
/****************DEBUT INSERTION DANS LA TABLE PROJET****************************************/                             
                            ...
                            $reqInsertProjet = 'insert into projets'
                                    . ' (RefProjet, NomProjet, RefClient, TypeProjet, Origine, cloture, '
                                    . ' Datesignature, Datearchctr, Avenantctr, Datesignaven, Paysmission, Villemission, Chefmission, DateDebutProjet, DateFinProjet, DateDebutR, DateFinR,'
                                    . ' typeclient, stat, nif, cif, rcs,'
                                    . ' RefSociete, DeviseCa, Reftypehono, Modefachono, Deboursrefact, Modefacdebour, Interlocfacture, Adressefacture, Monnaie, EstimationCoutTotalProjet, EstimationCoutDebours, Coordoninterloc, Abonnement, datemodification, nombremodification, usermodif, UT) values'
                                    . ' ("'.$cdeMission.'", "'.$mission.'", "'.$CliRef.'", "'.$categorie.'", "'.$origine.'", 0, '                                    
                                    . ' "'.$signContrat.'", "'.$dteArchiv.'", "'.$avenant.'", "'.$dteAvenant.'", "'.$paysMission.'", "'.$villeMission.'", "'.$chef.'", "'.$dtePrevu.'", "'.$dteFin.'", "'.$dbuReel.'", "'.$finReel.'", '
                                    . ' "'.$typeClient.'", "'.$stat.'", "'.$nif.'", "'.$cif.'", "'.$rcs.'", '
                                    . ' "'.$RefSoc.'", "'.$CA.'","'.$typehono.'","'.$mod_fac.'","'.$debPayer.'","'.$modFact.'","'.$interFac.'","'.$adresseFact.'","'.$devizy.'","'.$montantHono.'","'.$montantDeb.'","'.$Coord.'", 0 , NOW(), 0, "'.$refEmp.'", NOW())';
                            
                            $reqProjet = mysqli_query($connect,$reqInsertProjet);                                                          
