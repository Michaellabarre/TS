...
//                                $reqListPeriod = mysqli_query($connect,'select PERIODE from periode where DateEntree between "2015-01-01" and "2015-12-31";');
                        ...
                        if (isset($_POST['go'])){
                            if($_POST['periode'] == ''){						
                                ...
                                <center>
                                <div>                                                                           
                                    <form id="saisits" onsubmit="return verifAll(this)">                                        
...
//                                                                                echo "<tr id=\"".$numligne."\" >";                                                                                                                                                                                                                                                
                                                                                ...
                                                                                if($user_agent_name == 'Mozilla Firefox' or $user_agent_name == 'Internet Explorer' or $user_agent_name == 'navigateur inconnu'){
                                                                                    echo '<td width=150px><input class="datepicker"  name="dateMvt[]" type="date" style="width:150px;text-align: center"/></td>';
                                                                                }
...
//                                                                                    echo '<input type="hidden" id="numtot" name="numtot" value="'.$numtot.'" />';
                                                                                    ...
                                                                                    if($user_agent_name == 'Mozilla Firefox' or $user_agent_name == 'Internet Explorer' or $user_agent_name == 'navigateur inconnu'){
                                                                                        echo '<td width=150px><input class="datepicker" name="dateMvt[]" type="date" value="'.changeDate2($row['Date']).'"  style="width:150px;text-align: center" /></td>';
                                                                                    }
                                                                                    else{
...
//                                window.location.reload();
                                ...
                                $("#successGlobal").text("Enregistrement terminé");  
