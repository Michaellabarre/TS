	...
	.legend
{
  ...
  margin-left:16px;
		...
		// FONCTION DE RECCUPERATION DE L'INDEX D'UNE CHAINE
			...
			// FIN FONCTION DE RECCUPERATION DE L'INDEX D'UNE CHAINE
        </script>
    </head>
    <body>
    ...
    <div id="main">
		...
		<table>
            <form id="codeClientChoix" name="codeClientChoix" method="post">													                                                    
                <tr><td><select name="code_client" id="code_client" style="width:173px">									
                ...
                <td><input type="submit" name="selectionner" id="selectionner" value="Selectionner" /></td></tr>
            </form>
			</table>
            
            
            
                        <!-- ACTION DE SELECTION D'UN CLIENT VIA LE BOUTON SELECTIONNER ET AFFICHAGE INTERFACE DE L'UTILISATEUR-->
...
//                                echo 'val '.$val;
                                $req = 'SELECT RefClient, NomSociete, CodePostal, Activite, PaysRegion, Ville, Adresse, TitreContact, NomContact,Fonction, NumeroTel, NumTelecopie, NumMobile, Mail, siteweb,beneficiaire,payeur,'
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                     <ul style=" list-style-type: none">
                                                    <!--<fieldset style="border-color: #F0F5FF">-->
                                                   <Fieldset> <legend><b>CODE PROJET CLIENT</b></legend>           
                                                        <table>
                                                            <br/>
                                                            <tr>
                                                ...
                                                <td>
                                                     <ul style=" list-style-type: none">
                                                    <!--<fieldset style="border-color: #F0F5FF">-->
                                                   <Fieldset> <legend><b>FONCTION / ACTIVITE</b></legend>    
                                                        <table>       
                                                            <br/>
                                                            <tr>
                                                ...
                                                <td>
                                                    <ul style=" list-style-type: none">
                                                    <!--<fieldset style="border-color: #F0F5FF">-->
                                                   <Fieldset> <legend><b>INFOS ADMINISTRATIVES</b></legend>    
                                                        <table>
                                                        <br/>
                        ...
                        // FIN ACTION DE SELECTION D'UN CLIENT VIA LE BOUTON SELECTIONNER
						
                        // ACTION DE MAJ DU CLIENT A MODIFIER
...
//                            echo 'balance agé: '.$_POST['balanceagee'];
                            ...
                            if($requette) {
                                ...
                                $mysqli->query("COMMIT"); // METTRE A JOUR LA BASE SI LA REQUETTE EST VRAI : TRANSACTION
                        	}                        
                                else {
                                   ?>
                                    <script>
                                    ...
                                    echo '</b></p></div>';            
                                    $mysqli->query("ROLLBACK");exit(1); // NE PAS METTRE A JOUR LA BASE SI LA REQUETTE EST FAUX : TRANSACTION
...
//                                        echo 'liliiiiii: '.$resultMAJMission -> RefProjet;
                                        ...
                                        if($reqMissionMAJ){}
                                            ...
                                            echo '<br/><font size="0.5em">Erreur MAJ mission: '.mysqli_error($connect).'</font>'; // Gestion des excéption en cas d'erreur
                                        }
                                    }
                                }
                                else {
						...
						// FIN ACTION DE MAJ DU CLIENT A MODIFIER
                        ?>                                                
                    <!--</div>-->               
                    <!-- bottom -->
                </div>
...
<!--    <script type="text/javascript">
	...
	<!-- /bottom -->
        ...
        <script type="text/javascript">  
		// DIFFERENTES FONCTIONS JS A APPELLER POUR LA GESTION DU FORMULAIRE
                $(document).ready(function(){
...
//                                $('#labNomSociete').css("display", "none");
	...
	// FIN DIFFERENTES FONCTIONS JS A APPELLER POUR LA GESTION DU FORMULAIRE				
            </script>	
