				...
				<ul id="nav">
					...
					<li><a href="../consultant/index.php">CONSULTANTS</a>
						<ul>
							...
							<li><a href="../consultant/listeconsultant.php"><b>Liste des consultants</b><img src="../images/membree.png" border="0" width="15" height="15" align="absmiddle"></a></li>
					...
					<li><a href="../mission/index.php">MISSIONS</a>
						<ul>
							...
							<li><a href="../mission/missiondept.php"><b>Mission par Département</b></a></li>
						</ul>
					</li>
...
//                                echo 'select PERIODE from periode where DateEntree between "'.$first.'" and "'.$end.'"';
                        ...
                        ?>
						<table>
                        <tr><td><select name="periode" id="periode" style="width:205px">
...
//                                $reqListPeriod = mysqli_query($connect,'select PERIODE from periode where DateEntree between "2015-01-01" and "2015-12-31";');
                        ...
                        <td><input type="submit" name="go" id="go" value="Selectionner" /></td></tr>   
						</table>
                    </form>
                    </div>
                </div>
                                    ...
                                    <form action="./sauveTS.php" name="kaka" id="kaka" method="post">                                           
                                        ...
                                        <div>
                                            <table  border="1" max-width="1120px" > 
                                                <tr>
                                                    <td>
                                                        <table cellspacing="0" cellpadding="0" border="1"  width="1300px" >
                                                            <td class="time" colspan="5" ><center><strong>TIME SHEET</strong></center></td>
                                                            <td class="dep" colspan="3"><center><strong>DEPENSES LIEES</strong></center></td>
                                                            <td class="vide"></td>
                                                        </table>
                                                    </td>
...
//                                                                        echo 'valRef '.$valRef;
                                                                        ...
                                                                        $reqManager = 'select F.RefFichePointage as FRP, D.RefProjet as projet, D.Coddept as coddept, '
                                                                                ...
                                                                                . 'order by E.Prenom';                                
                                                                        $resMan = mysqli_query($connect, $reqManager) or exit(mysqli_error($connect));                                                     
...
//                                                                            echo '<br/>Projet: '.$res['projet']. ' - prenom: '.$res['prenom'];
                                                                            ...
                                                                            $resTSMan = mysqli_query($connect, $reqTSMan) or exit(mysqli_error($connect));
                                                                            if(!$resTSMan){
