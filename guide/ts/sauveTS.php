...
//    error_reporting(e_all);    
    ...
    // REQUETE DE MAJ DATE DE VALIDATION
     $sql = 'UPDATE heuresfichepointage SET Facture=1, Date_validation_TS = "'.date("Y-m-d").'" WHERE RefDetailFichePointage IN ('.$recherche.')';
    $res = mysqli_query($connect,$sql);

    if($res){
        $mysqli->query("COMMIT");
        $fraisUp = 'update fraisfichepointage set Facture=1, Date_validation_TS = = "'.date("Y-m-d").'"  where RefDetailFichePointage IN ('.$recherche.')';
        ...
        <div id="container" > 
            <center>
				...
				<br/><br/><br/>
                    ...
                    <div id="dp">
                        <?php
                            if($res) {echo '<br/><br/><br/><center><font color="green" size = "3"><b>Time Sheet valid&eacute;.</font></b></center>';}
