            ...
            if($prof == 'Associé' or $prof == 'Manager'){
              ...
              <!--      <nav class="menu">  
                ...
                <!-- tabs -->
					...
					<li><a href="../mission/index.php">MISSIONS</a>
						<ul>
							<li><a href="../mission/missioncode.php"><b>Fiche Mission</b> <img src="../images/dossier.png" border="0" width="15" height="15" align="absmiddle"> </a></li>
							<li><a href="../mission/missiondept.php"><b>Mission par Départ.</b></a></li>
						</ul>
					</li>
					<li><a href="../ts/index.php">TIMESHEET</a>
...
//                                        order by D.Coddept, D.RefProjet, C.NomSociete, P.NomProjet ;';
                                ...
                                if($ligne == 0){
                                    ...
                                    if(isset($_POST['selectionner1'])){
                                        echo '<br/><strong><font color="gray"><center>MISSION EN COURS DU DEPARTEMENT '.$dept.'</center></font></strong>';
                                    }
                                    else if(isset($_POST['selectionner2'])){
                                        if($_POST['code_dept'] == 'TOUTES LES MISSIONS'){
                                            echo '<br/><strong><font color="gray"><center>MISSION CLOTUREES DE TOUS LES DEPARTEMENTS </center></font></strong>';
                                        }
                                        else{
                                            echo '<br/><strong><font color="gray"><center>MISSION CLOTUREES DU DEPARTEMENT '.$dept.'</center></font></strong>';
                                        }                                        
                                    }
                                    else if(isset($_POST['selectionner3'])){
                                        echo '<br/><strong><font color="gray"><center>TOUTES LES MISSION DU DEPARTEMENT '.$dept.'</center></font></strong>';
                                    }
                                ?>                                                                         
