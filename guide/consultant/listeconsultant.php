...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!-- <script type="text/javascript" src="TS/guide/consultant/French.json"></script> -->
        <!-- dragtable pour déplacer des colonnes d'un tableau-->
        <script src="draggable/dragtable.js"></script>
                ...
                ?>
				 ...
				 <!-- tabs -->
                    ...
                    <div>                                        
                        <a class='tab selected' href='../consultant/index.php'><span style="width: 100px; text-align:center;">CONSULTANTS</span></a>
                         <ul>
                             ...
                             <li><a class='tab selected' href='../consultant/listeconsultant.php'><span>Liste des consultants</span></a></li>                        
                   ...
                   <!--     </ul>
                    ...
                    <br/><br/><br/>
                    <font style=" color: black"><b><center>LISTE DE TOUS LES CONSULTANTS</center></b></font>
                    <br/>
                    </nav>
                    <!-- /tabs --> 
                <?php
            }
           // GESTION DE L'INTERFACE MODE ADMIN : => Login : Admin02 et Mdp : Admin02 
                    ...
                    <div>                                        
                        <a class='tab selected' href='./consultant/index.php'><span style="width: 100px; text-align:center;">CONSULTANTS</span></a>
                         <ul>
                             ...
                             <li><a class='tab selected' href='./listeconsultant.php'><span>Liste des consultants</span></a></li>                              
                        </ul>
                    </div>
                    <!--<div class="header"><div class="bg-help"></div></div>-->
                    <br/><br/><br/>
