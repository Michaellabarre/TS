    ...
    <div id="main">
        ...
        <div id="container" >
                ...
                <div>
                    ...
                    <?php
					// ACTION D'ENREGISTEMENT D'UN CONS. INTERNE : gestion des requête par transaction
...
//                            $dateNow = date('Y-m-d');   
					...
					// FIN ACTION D'ENREGISTEMENT D'UN CONS. INTERNE
                    ?>
                </div>
...
//                        alert("kaka");
			...
			// QUELQUES FONCTIONS POUR CONTROLE FORMULAIRE
