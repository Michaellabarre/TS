...
<!--                    <div class="note" id="note"><b><font color="red">Notes:</font></b> 
						...
						<!-- FIN ENTETE DU TABLEAU HTML -->
                                <!-- <td>
                                    <div style="height:450px; overflow-y: auto; overflow-x: hidden" width="820px"> 
                                            ...
                                            <?php
											// // AFFICHAGE DES RESULTATS DE LA LISTE DES CONS. EXTERNES VIA APPEL SQL
           ...
           //                                      echo '</tr>';
           //                                  }
										// FIN AFFICHAGE DES RESULTATS VIA APPEL SQL
                                            ?>
                         <!--                </table>
                                    </div>
                                </td>
        ...
        <tbody>
            ...
            <?php 
                $req='select RefEmploye as Code, Prenom as Prénom, NomFamille as Nom, Titre FROM employes where RefEmploye like "%E0%" and actif = 0 ORDER BY RefEmploye ASC;';
